  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-logo topbar-btn">
        <a href="/"><img src="@/assets/images/logo.png" style="padding-left:12px;"></a>
      </div>
      <div class="topbar-logos" v-show="!collapsed">
        <a href="/"><img src="@/assets/images/logotxt.png"></a>
      </div>
      <div class="topbar-title">
        <span style="font-size: 18px;color: #fff;">{{this.$store.getters.loginInfo.familyName}}</span>
      </div>
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          <span class="el-dropdown-link logininfo-inner">
            <i class="iconfont icon-user"></i> {{this.$store.getters.loginInfo.nickName}}
            <i class="el-icon-caret-bottom"></i>
          </span>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <div @click="jumpTo('/Account/Profile')">
                <span style="color: #555;font-size: 14px;">个人信息</span>
              </div>
            </el-dropdown-item>
            <el-dropdown-item>
              <div @click="jumpTo('/Account/ChangePwd')">
    ...
    <el-col :span="24" class="main">
      ...
      <aside :class="{showSidebar:!collapsed}">
        ...
        <!--导航菜单-->
        <el-menu unique-opened :default-active="activeMenu" router :collapse="collapsed">
