  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>借还明细</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-row :span="24">
        <el-form :inline="true">
          ...
          <el-form-item label="类型" class="toolbar-item">
            <BRMultipleSelect v-model="req.lstBRType"></BRMultipleSelect>
          </el-form-item>
        ...
        <el-form :inline="true" style="margin-top:10px;">
          <el-form-item label="对方" class="toolbar-item">
            <el-input v-model="req.target" placeholder="模糊匹配对方名称" style="width:150px;"></el-input>
          </el-form-item>
      ...
      <el-table
        ...
        :default-sort="{prop: 'brDate', order: 'descending'}"
      ...
      >
        ...
        <el-table-column
          ...
          sortable="custom"
        ></el-table-column>
        <el-table-column prop="target" label="对方" width="150" sortable="custom"></el-table-column>
        <el-table-column prop="brTypeName" label="类型" width="150" sortable="custom"></el-table-column>
...
import BRMultipleSelect from "@/components/brMultipleSelect";
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      //查询列表
      ReportAPI.queryBorrowRepayRecord(this.req).then(function(result) {
        if (result.isOK) {
          //表格设值
    ...
    sortList(column) {
      if (!column.prop || !column.order) {
        ...
        switch (column.prop) {
          case "brDate":
            this.req.sort = "brDate";
            break;
          case "target":
            this.req.sort = "target";
            break;
          case "brTypeName":
            this.req.sort = "brType";
            break;
