  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>转账明细</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-row :span="24">
        <el-form :inline="true">
          ...
          <el-form-item label="源账户" class="toolbar-item">
            <AAMultipleSelect v-model="req.lstFromAmountAccountID"></AAMultipleSelect>
          </el-form-item>

          <el-form-item label="目标账户" class="toolbar-item">
            <AAMultipleSelect v-model="req.lstToAmountAccountID"></AAMultipleSelect>
          </el-form-item>
        </el-form>
      ...
      <el-table
        ...
        :default-sort="{prop: 'transferDate', order: 'descending'}"
      ...
      >
        ...
        <el-table-column
          ...
          sortable="custom"
        ></el-table-column>
        <el-table-column prop="fromAmountAccountName" label="源账户" width="150" sortable="custom"></el-table-column>
        <el-table-column prop="toAmountAccountName" label="目标账户" width="150" sortable="custom"></el-table-column>
        <el-table-column
          prop="amount"
          label="金额"
          width="150"
...
export default {
  ...
  data() {
    return {
      ...
      req: {
        ...
        lstFromAmountAccountID: [], //源账户ID集合
        lstToAmountAccountID: [], //目标账户ID集合
        remark: "", //备注（模糊匹配）
        sort: "transferDate desc", //排序
        pageNum: 1, //当前页码
        pageSize: 100 //每页条数
      },
  ...
  methods: {
    ...
    search() {
      ...
      //查询列表
      ReportAPI.queryTransferRecord(this.req).then(function(result) {
        if (result.isOK) {
          //表格设值
    ...
    sortList(column) {
      if (!column.prop || !column.order) {
        ...
        switch (column.prop) {
          case "transferDate":
            this.req.sort = "transferDate";
            break;
          case "fromAmountAccountName":
            this.req.sort = "fromAmountAccountID";
            break;
          case "toAmountAccountName":
            this.req.sort = "toAmountAccountID";
            break;
          case "amount":
