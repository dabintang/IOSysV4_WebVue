    ...
    <el-col :span="24" class="warp-main">
      ...
      <el-row :span="24">
        <el-form :inline="true">
          ...
          <el-form-item label="类型" class="toolbar-item">
            <ITMultipleSelect v-model="req.lstInTypeID"></ITMultipleSelect>
          </el-form-item>
      ...
      >
        ...
        <el-table-column
          ...
          sortable="custom"
        ></el-table-column>
        <el-table-column prop="inTypeName" label="类型" width="150" sortable="custom"></el-table-column>
...
import ITMultipleSelect from "@/components/itMultipleSelect";
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      //查询列表
      ReportAPI.queryInRecord(this.req).then(function(result) {
        if (result.isOK) {
          //表格设值
