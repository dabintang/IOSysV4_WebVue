  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>借还</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main">
      ...
      <!--列表-->
      <el-table :data="list" :default-sort="{prop: 'amount', order: 'descending'}" highlight-current-row style="width: 100%;" :maxHeight="tableHeight" stripe>
        <el-table-column type="index" width="100"></el-table-column>
        <el-table-column prop="target" label="对方" sortable></el-table-column>
        <el-table-column prop="brTypeName" label="类型" sortable></el-table-column>
      ...
      <!--对话框-->
      <BorrowRepayDetail ref="form" @saved="saved"></BorrowRepayDetail>
    </el-col>
  </el-row>
</template>
<script>
...
import BorrowRepayDetail from '@/pages/inOut/borrowRepayDetail';
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      //查询列表
      InOutAPI.queryBorrowRepay(this.req.date).then(function(result) {
        if (result.isOK) {
          //列表设值
    ...
    deleteRecord: function(id) {
      ...
      this.$confirm('确认删除该记录吗?', '提示', { type: 'warning' }).then(() => {
        //删除
        InOutAPI.deleteBorrowRepay({ id: id }).then(function(result) {
          if (result.isOK) {
            //成功提示
